...
if [[ $JP -eq 1 ]]; then
    ...
    MSG_SETUP_BODY="ツールの依存関係をインストールしています。1〜2分かかります。"
    MSG_DONT_CLOSE="*** このウィンドウを閉じないでください ***"
    MSG_DONT_CLOSE_BODY="最大2分間、固まっているように見える場合があります。正常に動作中ですので、そのままお待ちください。"
    ...
    MSG_SETUP_BODY="Installing toolkit dependencies. This takes about 1-2 minutes."
    MSG_DONT_CLOSE="*** PLEASE DO NOT CLOSE THIS WINDOW ***"
    MSG_DONT_CLOSE_BODY="Even if it looks frozen for up to 2 minutes, it is still working. Just wait."
